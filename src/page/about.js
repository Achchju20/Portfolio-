    ...
    <div className={`h-screen ${darkModeClass}`}>
      ...
      <section className="flex flex-col md:flex-row items-center justify-center h-full px-6 md:px-16 py-12 space-y-8 md:space-y-0 bg-secondary1 dark:bg-gray-900">
        ...
        >
          ...
          >
Hi, I'm Achchuthan, a UI/UX designer and developer based in Sri Lanka. I specialize in crafting intuitive and engaging interfaces that enhance user experiences. Currently, I am pursuing my third year, first semester of studies in Information Technology at SLIIT, where I'm honing my skills in designing secure and user-friendly digital solutions. I’m passionate about blending creativity with functionality to create seamless, interactive designs that resonate with users.
</motion.p>
          ...
          <motion.div 
            ...
            >
              My work focuses on creating designs that are both visually appealing and highly functional. I also have experience in the MEAN stack.
            </motion.div>
            <motion.div 
...
>
  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
    ...
    {/* Skill Box 4 */}
    <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-md flex justify-center items-center text-center">
      <p className="text-lg font-medium">Android  studio</p>
    </div>

    {/* Skill Box 5 */}
    <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-md flex justify-center items-center text-center">
      <p className="text-lg font-medium">MEAN Stack</p>
    </div>
    <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-md flex justify-center items-center text-center">
