...
import logo from '../img/Achchu logo.png'; // Make sure this path is correct
...
export default function Header() {
  ...
  const handleDownloadResume = () => {
    ...
    link.download = 'Achchjuthan"s resume'; // Name the file when downloaded
    link.click();
  };
  ...
  return (
    <header className="sticky top-0 z-50 flex justify-between items-center px-5 py-5 bg-primary text-white shadow-md">
      ...
      <nav className="hidden md:block">
        <ul className="flex space-x-12 font-bold text-2xl"> {/* Add the text-lg class here to increase the font size */}
